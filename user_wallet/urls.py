...
urlpatterns = [
    ...
    path('dashboard-cards/overview/', DashboardOverviewAPIView.as_view(), name='dashboard-cards'),
    path('wallet-cards/overview/', WalletOverviewOptimizedAPIView.as_view(), name='wallet-cards'),
